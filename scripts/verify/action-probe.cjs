...
const PARAM_SETS = {
  ...
  edit: [
    ...
    { chatId: IN_SCOPE },
    { chatId: IN_SCOPE, messageId: 7 },
    { chatId: IN_SCOPE, messageId: 7, text: "probe" },
    { chatId: IN_SCOPE, messageId: 7, text: "NO_REPLY" },
    { chatId: OUT_OF_SCOPE, messageId: 7, text: "probe" },
  ],
...
const SPELLINGS = {
  ...
  read: [ "read", "list" ],
  react: [ "react" ],
  edit: [ "edit", "editMessage", "edit-message", "update" ],
  joins: [ "joins" ],
